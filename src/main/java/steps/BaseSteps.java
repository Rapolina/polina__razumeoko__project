...
public class BaseSteps {
    ...
    public static void followTheLinkSetWindowMode(WebDriver driver, String url, ScreenView screenMode) {
        DriverView.setScreenView(screenMode, driver);
        driver.get(url);
    }
